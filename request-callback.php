...
function wpcallback_get_colour() {
	...
	if( isset( $wpcallback_plugin_option['colour'] ) && $wpcallback_plugin_option['styling'] != 'custom')
...
function wpcallback_display_button() {
	...
	echo '<a href="' . wpcallback_get_callback_page() . '" data-formwidth="' . $form_width . '" class="callback-btn-style ' . wpcallback_get_styling() . ' ' . wpcallback_get_colour() . ' ' . wpcallback_get_position() . ' ' . wpcallback_get_option("classes") . ' callback-btn-settings callback-form-show">' . wpcallback_get_option("label") . '</a>';
}
